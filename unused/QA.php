...
<head>
    ...
    <link href="../views/css/styleQA.css" rel="stylesheet">
</head>
...
<body>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 margin-bottom-20">
                            <div class="fat-heading-abb">
                                <a href="single-category.html">
                                    <i class="fa fa-folder"></i> gomac Configurations
                        ...
                        <div class="col-md-6 margin-bottom-20">
                            <div class="fat-heading-abb">
                                <a href="single-category.html">
                                    <i class="fa fa-folder"></i> Products
                                    <span class="cat-count">(60)</span>
                                </a>
                            </div>
                            <div class="fat-content-small padding-left-30">
                        ...
                        <div class="col-md-6 margin-bottom-20">
                            <div class="fat-heading-abb">
                                <a href="single-category.html">
                                    <i class="fa fa-folder"></i> Customers
                                    <span class="cat-count">(60)</span>
                                </a>
                            </div>
                            <div class="fat-content-small padding-left-30">
                        ...
                        <div class="col-md-6 margin-bottom-20">
                            <div class="fat-heading-abb">
                                <a href="single-category.html">
                                    <i class="fa fa-folder"></i> Suppliers
                                    <span class="cat-count">(60)</span>
                                </a>
                            </div>
                            <div class="fat-content-small padding-left-30">
    ...
    <script src="../views/js/jquery-2.2.4.min.js"></script>
    <script src="js/mainQA.js"></script>
